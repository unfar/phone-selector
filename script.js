...
const brandLogos = {
  ...
  'REDMI': 'data:image/svg+xml;base64,',
  ...
  'realme': 'data:image/svg+xml;base64,',
...
// 一些品牌需要使用更大的 logo
const largeLogoBrands = new Set(['OPPO','Lenovo','Samsung','vivo']);
function getLogoStyle(brand) {
    return largeLogoBrands.has(brand) ? 'height:28px;width:auto' : 'height:22px;width:auto';
}
    ...
    grid.innerHTML = filtered.map(p => {
        ...
        return '<div class="' + cardClass.join(' ') + '" data-id="' + p.id + '">' +
            '<div class="card-header brand-header-' + p.brand + '">' +
                '<span class="brand-badge"><img class="brand-logo" style="' + getLogoStyle(p.brand) + '" src="' + brandLogos[p.brand] + '" alt="' + p.brand + '"></span>' +
                priceHtml +
